...
Decomposing differences in case fatality rates over time or between countries reveals crucial insights for monitoring the spread of COVID-19. Our results show that differences between countries with low and high CFRs can be driven to a significant extent by the age structure of cases. More research is required to better understand why the age composition can play such a large role.
